...
class CSV {
  ...
  */
  ...
  /**
    ...
    Insert, <a href="${docBaseUrl}/test-reports/org.camunda.latera.bss.utils.CSVSpec.html#%2B+operator+for+Map+input+-+update">update</a> or <a href="${docBaseUrl}/test-reports/org.camunda.latera.bss.utils.CSVSpec.html#%2B+operator+for+Map+input+-+replace">replace</a> data in CSV.
    <p>
    Examples:
