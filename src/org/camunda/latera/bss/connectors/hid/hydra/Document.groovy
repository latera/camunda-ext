...
trait Document {
   ...
   * @deprecated Use {@link #getRecipientRole} instead
   */
   ...
   * @deprecated Use {@link #getRecipientRoleId} instead
   */
   ...
   * @param endDate     {@link java.time.Temporal Any date type}. Optional
   * @param firmId      {@link java.math.BigInteger BigInteger}. Optional. Default: current firm id
   * @return Created document (in Oracle API procedure notation)
   */
   ...
   * @deprecated Use {@link #getDocumentRecipientBy} instead
   */
  Map getDocumentReceiverBy(Map input) {
    return getDocumentRecipientBy(input)
  }

  /**
   * Get document receiver by doc id
   * @deprecated Use {@link #getDocumentRecipient} instead
   */
  Map getDocumentReceiver(def docId) {
    return getDocumentRecipient(docId)
  }
